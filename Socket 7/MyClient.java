...
l4 = new JLabel("Server Response :");
l4.setBounds(10,5,100,25);
l4.setForeground(Color.GREEN);
p1.add(l4);
l5 = new JLabel("Your Massage :");
...
bc1.addActionListener(new ActionListener() {
	@Override
	public void actionPerformed(ActionEvent e) {
        pw.println(tc2.getText());//write the value of textfield into PrintWriter
		ta2.setText(tc2.getText());
		tc2.setText("");//clean the textfield
}});
p2.add(bc1);
